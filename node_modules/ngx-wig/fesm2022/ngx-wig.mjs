...
class NgxWigComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.0", ngImport: i0, type: NgxWigComponent, deps: [{ token: NgxWigToolbarService }, { token: DOCUMENT }, { token: 'WINDOW' }], target: i0.ɵɵFactoryTarget.Component }); }
...
class NgxWigModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.0", ngImport: i0, type: NgxWigModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.0.0", ngImport: i0, type: NgxWigModule, declarations: [NgxWigComponent], imports: [CommonModule,
            FormsModule], exports: [NgxWigComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.0.0", ngImport: i0, type: NgxWigModule, providers: [
            { provide: BUTTONS, multi: true, useValue: DEFAULT_LIBRARY_BUTTONS },
            { provide: 'WINDOW', useFactory: getWindowObject },
        ], imports: [CommonModule,
            FormsModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.0", ngImport: i0, type: NgxWigModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        NgxWigComponent
